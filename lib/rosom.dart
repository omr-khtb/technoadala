...
class Rosoom extends StatefulWidget {
  @override
  _RosoomState createState() => _RosoomState();
}

class _RosoomState extends State<Rosoom> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                // Text on the right
                Text(
                  'ماهي الرسوم؟',style: GoogleFonts.almarai(
                    fontSize: 20,
                    color: Colors.grey
    ...
    child: Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              selectedOption ?? 'نوع الرسوم', // Display selected option or empty string
              textAlign: TextAlign.right,
              style: TextStyle(
                fontFamily: 'Almarai',
                fontSize: 20,
