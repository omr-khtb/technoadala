...
class Tawzee3_3ml extends StatefulWidget {
  @override
  _Tawzee3_3mlState createState() => _Tawzee3_3mlState();
}

class _Tawzee3_3mlState extends State<Tawzee3_3ml> {
                ...
                children: [
                  ...
                  if (_showContainer45obraa)
                    _container45obraa(
                        ...
                        onPressed: () {
                          Navigator.of(context).pushNamed('/Tawzee3');
                    }
                    ),
                  SizedBox(height: 20,),
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Image.asset('assets/tawzee3_fnc.png',
                                    ) ,
                                    SizedBox(width: 12,),
                                    Text('توزيع العمل',
                                        style: GoogleFonts.almarai(
...
Widget _container45obraa({
  ...
  required final VoidCallback onPressed,// Added onPressed callback
