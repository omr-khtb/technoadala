...
class A3maly extends StatefulWidget {
  @override
  _A3malyState createState() => _A3malyState();
}

class _A3malyState extends State<A3maly> {
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        TextButton(
                                                          onPressed: () {
                                                            Navigator.of(context).pushNamed('/GalasatMa7kma');
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        TextButton(
                                                          onPressed: () {
                                                            Navigator.of(context).pushNamed('/Galasat5obra2');
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        TextButton(
                                                          onPressed: () {
                                                            Navigator.of(context).pushNamed('/Egra2att');
                                                          },
                                                          child: Text(
                                                            'اظهار المزيد',
                                                            style: GoogleFonts.almarai(
...
SizedBox(height: 20,),
                                                  ...
                                                  children: [
                                                    Row(
                                                      children: [
                                                        ...
                                                        TextButton(
                                                          onPressed: () {
                                                            Navigator.of(context).pushNamed('/Ta72e22');
                                ...
                                GestureDetector(
                                  onTap: () {
                                  Navigator.of(context).pushNamed('/Allworks');
