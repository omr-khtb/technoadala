...
class Allworksv2 extends StatefulWidget {
  @override
  _Allworksv2State createState() => _Allworksv2State();
}

class _Allworksv2State extends State<Allworksv2> {
  ...
  void _toggleArrow2() {
    setState(() {
      ...
      _showContainer45obraa =
      !_showContainer45obraa; // Hide the other container
    });
  }
                ...
                children: [
                  ...
                  if (_showContainer45obraa)
                    _container45obraa(
                        ...
                        time: '',
                        mawdoo3: '',
                        casenum: ' 50000/2024 اثبات حاله مستعجل 20',
                        khober: '',
                        qa3a: '',
                        floor: '', Almo7amy: ''
                    ),
